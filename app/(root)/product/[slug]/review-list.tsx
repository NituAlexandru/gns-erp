...
//       toast({
//         variant: 'destructive',
//         description: 'Eroare la încărcarea recenziilor',
//       })
//     }
//   }
...
//       {reviews.length === 0 && <div>Nu există recenzii</div>}
...
//             </h3>
//             <p className='text-sm'>Împărtășește-ți părerea cu alți clienți</p>
//             {userId ? (
...
//                     <Check className='h-4 w-4' /> Achiziție verificată
//                   </div>
//                 </div>
...
//                     {review.user ? review.user.name : 'Utilizator anonim'}
//                   </div>
//                   <div className='flex items-center'>
