...
interface ClientBalancesReportDialogProps {
  open: boolean
  onOpenChange: (open: boolean) => void
  report: ReportDefinition | null
}

export function ClientBalancesReportDialog({
  open,
  onOpenChange,
  report,
}: ClientBalancesReportDialogProps) {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      if (result.success && result.data && result.filename) {
        ...
        toast.success('Raport Solduri generat cu succes!')
        onOpenChange(false)
      } else {
        ...
        <div className='flex flex-col gap-5 py-4'>
          ...
          <div className='flex items-center space-x-2 bg-muted/50 p-3 rounded-lg border'>
            ...
            <div className='flex flex-col gap-1'>
              ...
              <span className='text-xs text-muted-foreground'>
                Dacă bifezi, raportul va lista sub fiecare client toate
